    ...
    <div ref={containerRef}>
      <section className="block">
        ...
        <p className="sub">
          ...
          service de la création d’interfaces modernes.
        </p>
      ...
      <section className="body today">
        <div className="todayContainer">
          ...
          <p>
            Je me spécialise en développement Front-End avec React et Next.js. Je conçois des
            interfaces modernes en mettant l’accent sur la performance, l’expérience utilisateur et
            un code propre, scalable et maintenable.
          </p>
      ...
      <section className="body blocContact">
        <div className="contact">
          <h2>
            Envie de travailler <em>ensemble</em> ?
          </h2>
